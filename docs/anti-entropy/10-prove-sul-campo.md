...
| P2 | 2026-09-17 | no, primo giro | Generazione riuscita: 2 Page Object, 1 file di step, 1 feature. 7 buchi dichiarati — 4 componente-non-nel-dizionario, 1 nessuno-step-di-catalogo, 1 ancoraggio-instabile, 1 asserzione-non-verificabile. **Non compila** (12 errori): l'elenco e il dettaglio della stessa risorsa avevano lo stesso nome di classe, e la seconda Page Object ha sovrascritto la prima. Difetto del generatore, corretto con i casi di controllo. In piu' il bersaglio era configurato sull'altro dominio rispetto alla registrazione. **22/09, quarto giro: 5 passi su 11 verdi** — login compreso, fatto dal test stesso. Si ferma su un'azione di riga: il pulsante esiste in 100 copie, una per riga, e nessun filtro lo distingue. E' il caso previsto in P6, arrivato prima del previsto. Difetti corretti nel frattempo: nomi di pagina duplicati, ruolo `text` inesistente, timeout a 5 secondi, campo password cercato per il suo mascheramento, ancoraggio preso da una verifica invece che dal primo elemento toccato |
