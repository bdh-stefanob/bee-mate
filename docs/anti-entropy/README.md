...
| D20 | La coda dichiara **di che giudizio** ha bisogno ogni gruppo (LINGUAGGIO / TECNICO), e ammette **quattro** decisioni: eleggi · scrivi · **spezza** · rinvia | Le colonne della matrice non le giudica la stessa persona: il dato e' automatico, la lingua e' del QA, la fattibilita' dell'SDET. E **spezzare deve essere di prima classe**: il clustering puo' fondere intenzioni diverse, e se l'unica opzione e' sceglierne una si sancisce una Gold sbagliata — peggio dell'entropia di partenza |
