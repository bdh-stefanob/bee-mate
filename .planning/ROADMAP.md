...
- [x] 999.17-04-PLAN.md — Drag&drop nell'albero (MOVE-01)
- [x] 999.17-05-PLAN.md — Fix Save: nome file stabile, in-place/sposta/nuovo, anti-overwrite (TAG-PLACE-01, checkpoint finale)
